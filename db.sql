...
CREATE TABLE `book_shelf` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_shel` (`user_id`,`book_id`),
  KEY `user_id` (`user_id`),
  KEY `book_id` (`book_id`),
...
INSERT INTO `user` VALUES (1,'Igor','Flyunt','USER','iflyunt','root'),(2,'Test','test','USER','usr','usr');
