    ...
    <div class="row">
        <div class="col-lg-4 ">
            <div class="list-group text-center float-left">
                <a href="/user/bookshelf" class="list-group-item my-2">All</a>
                <a href="/user/bookshelf?shelf=currently-read" class="list-group-item my-2">Currently reading</a>
        ...
        <div class="col-lg-4 ">
            <h3 class="text-justify"> ${bookShelfName}</h3>
