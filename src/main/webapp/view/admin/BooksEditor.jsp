        ...
        <div class="row mx-auto accordion" id="bookItem${book.id}">
            <div class="col-lg-4 mx-auto my-2">
                <div class="row-fluid  mx-auto border-top media">
                    <div class="container media-object my-2">
                        <div class="row mx-auto">${book.name}</div>
                        <div class="row mx-auto">
                            <c:forEach var="author" items="#{book.authors}">
                                <small><a href="/admin/author#a${author.id}">${author.firstName} ${author.lastName}</a></small>
                            </c:forEach>
                        </div>
                    </div>
